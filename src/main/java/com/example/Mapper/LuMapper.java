...
public interface LuMapper {
    //查询所有鲁菜
    @Select("select id,name,price,detail,image,category,create_time,update_time from dish where category = 3")
    ...
    //    查询所有菜品
    @Select("select name,price,detail from dish where category = 3")
